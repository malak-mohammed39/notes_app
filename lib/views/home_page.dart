...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final card =
        widget.isDark ? const Color(0xFF332C36) : HomePage.cardColor;

    final text =
        widget.isDark ? Colors.white : HomePage.textColor;

    final search =
        widget.isDark ? const Color(0xFF4B3158) : HomePage.darkPurple;
                ...
                builder: (context, state) {
                  if (state is NotesSuccess) {
                    ...
                    return ListView.builder(
                      itemCount:
                          displayCount + (notes.length > 3 ? 1 : 0),
